---
name: webhooks
description: 注册 HeyGen 的 Webhook 端点和事件类型
---
...
Webhook 不是在重复检查视频状态，而是在以下情况**推送**通知到你的服务器：
- 视频生成完成
- 视频生成失败
- 翻译完成
- 头像训练完成
...
| `instant_avatar.success` | 即时头像创建完成 |
| `instant_avatar.fail` | 即时头像创建失败 |
...
通过 HeyGen 仪表盘或 API 配置你的 Webhook URL：
