---
name: latex
description: MathTex、Tex、LaTeX 渲染和 Manim 中的公式样式
metadata:
...
1. **使用原始字符串** —— LaTeX 始终使用 `r"..."` 
2. **纯数学使用 MathTex** —— 比添加 `$...$` 更简单
3. **混合内容使用 Tex** —— 当需要组合文本和数学时
4. **拆分以便动画控制** —— 将要分别动画化的部分分开
