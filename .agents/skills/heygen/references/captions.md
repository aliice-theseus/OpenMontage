---
name: captions
description: HeyGen 视频的自动生成字幕选项
---
...
1. **始终启用字幕** - 改善聋哑/听障观众的可访问性
2. **使用高对比度** - 深色背景上白色文本，或反之
3. **可读字体大小** - 标准视频至少 24px，移动端更大
4. **不要覆盖重要内容** - 将字幕放在远离关键视觉元素的位置
...
详见 [video-translation.md](video-translation.md) 了解更多详情。
