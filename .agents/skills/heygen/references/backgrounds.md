---
name: backgrounds
description: HeyGen 视频的纯色、图像和视频背景
---
...
- **格式**：JPEG、PNG
- **推荐尺寸**：匹配视频尺寸（如 1080p 为 1920x1080）
- **宽高比**：应匹配视频宽高比
- **文件大小**：推荐 10MB 以下
...
4. **优化文件大小** - 压缩图像/视频以加快处理速度
5. **测试绿幕** - 用于专业后期制作工作流
6. **保持背景简洁** - 避免虚拟角色后出现分散注意力的元素
...
如果背景与视频尺寸不匹配，可能会被裁剪或拉伸。始终将背景宽高比与视频尺寸匹配：
...
背景视频音频通常被静音，以避免与虚拟角色的声音冲突。如果您需要背景音乐，请在后期制作中将其添加为单独的音频轨道。
